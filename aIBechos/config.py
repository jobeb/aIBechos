...
DEFAULTS = {
    ...
    # {tmdb_id_str: epoch} -- cuándo se activó el rayo ⚡ de cada serie
    # (para el tooltip "activo desde..."). Personal de cada instalación,
    # igual que missing_ep_auto_complete; las series activadas antes de
    # que existiera esta clave simplemente no tienen fecha.
    "missing_ep_auto_since": {},
...
"amule_search_type": "Kad",
    ...
    "page_size": "Ajustado",
    # Tamaño deseado por serie para "Adelgazar" en Liberar espacio (ver
    # core/slim_candidates.py): {nombre_normalizado: MB}. Manda sobre la
    # mediana y el techo por resolución -- sirve para series donde TODO es
    # pesado y la mediana sale inflada. Se edita desde la propia fila
    # expandida de la serie ("Deseado: [___] MB").
    "slim_desired_sizes": {},
}
