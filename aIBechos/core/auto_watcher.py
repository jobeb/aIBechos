...
class AutoWatcher:
    def __init__(self, folder: str, config, tmdb_client, ftp_client, on_event, on_file_event=None,
        ...
        on_file_event(path, tipo, **kwargs)
          ...
          | "slim_replaced" (tras subir con éxito la ligera de un reemplazo
          por adelgazamiento -- ver core/slim_pending.py)
        ...
        with self._ftp_lock:
            ...
            if _slimpend is not None:
                ...
                if _heavy_remote_size is None:
                    ...
                    self.on_event("info", f"El gordo ya no estaba, se sube la ligera: {new_name}")
                    try:
